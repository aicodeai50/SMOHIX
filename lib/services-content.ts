/**
 * Smohix Technologies professional services — revenue path alongside product development.
 * No invented pricing; CTAs route to pilot application.
 */

export type SmohixService = {
  id: string;
  title: string;
  problem: string;
  outcome: string;
...
export const SMOHIX_SERVICES: readonly SmohixService[] = [
  {
    id: "ai-integration",
    ...
    relatedProducts: ["Smohix AI", "Smohix Platform"],
  },
  {
    id: "internal-systems",
    ...
    relatedProducts: ["Smohix Platform", "Projects"],
  },
  {
    id: "api-development",
    ...
    audience: "Engineering teams building on Smohix Own API and ingest.",
    relatedProducts: ["Smohix Own API", "Developers"],
  },
  {
    ...
    relatedProducts: ["Agents", "Smohix Platform"],
  },
  {
    id: "cloud-deployment",
    ...
    audience: "DevOps teams deploying smohix.run and connected workspaces.",
    relatedProducts: ["Smohix Platform", "Smohix Own API"],
  },
  {
    id: "dashboards",
    ...
    relatedProducts: ["Analytics", "Smohix Platform"],
  },
  {
    ...
    relatedProducts: ["Developers", "Smohix Own API"],
  },
  {
    id: "prototyping",
    title: "Technical prototyping",
    problem: "Ideas need a fast path to a working prototype with honest maturity labels.",
    outcome: "Preview or prototype modules on smohix.run with a clear roadmap to production.",
  ...
  },
  {
    ...
    relatedProducts: ["Knowledge", "Smohix Platform"],
  },
  {
    id: "security-ops",
    ...
    relatedProducts: ["Smohix Platform", "Identity"],
  },
] as const;
