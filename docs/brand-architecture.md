...
Products belong to Smohix but may use **distinct product marks** under a shared design language:

| Product | Domain | Mark status |
| --- | --- | --- |
| Smohix AI | ai.smohix.run | Aperture S (product identity) |
| Smohix Platform | platform.smohix.run | May receive dedicated mark |
| Smohix Identity | identity.smohix.run | May receive dedicated mark |
| Smohix Assistant | assistant.smohix.run | May receive dedicated mark |
