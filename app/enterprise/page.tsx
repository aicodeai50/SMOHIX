...
const packages = [
  ...
  },
  {
    ...
    body: "Per-user isolation with RLS today; org-scoped roles and delegated approvers on the roadmap for shared SOCs.",
  },
  {
      ...
      <main className="flex-1 border-b border-white/[0.06]">
        <div className="zentro-hero-future border-b border-white/[0.06]">
          <article className={`${mArticle} max-w-4xl`}>
            <p className={mEyebrow}>Enterprise</p>
            ...
            <p className={`mt-4 ${mBody} text-base sm:text-lg`}>
              ...
              single command layer: incidents, threat visibility, guarded change, and evidence that
              survives audits — without replacing the tools you already trust.
            </p>
        ...
        <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-16">
          <h2 className={mH2}>What enterprise includes</h2>
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            {packages.map((pkg) => (
              <div key={pkg.title} className={mCard}>
          ...
          <section className="mt-12 rounded-2xl border border-white/[0.08] bg-white/[0.02] p-6 sm:p-8">
            <h2 className={mH2}>Procurement checklist</h2>
            <ul className={`mt-4 space-y-2 ${mBody}`}>
              <li>Data residency via your Supabase project region</li>
              <li>FedRAMP-oriented deployment profile — region pin + GovCloud boundary at /settings/deployment</li>
              <li>Row-level security per authenticated user</li>
              <li>Service-role isolation for webhooks and audit append</li>
              <li>Public trust, security, and privacy commitments at /trust and /security</li>
