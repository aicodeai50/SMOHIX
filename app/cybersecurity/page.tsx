...
export const metadata: Metadata = {
  title: "Cybersecurity",
  description:
    "Threat surface, exposure scanning, penetration workflows, and guarded remediation — unified in the Smohix command platform.",
};
        ...
        <main className="flex-1 border-b border-white/[0.06]">
          <div className="smohix-hero-future smohix-quantum-section border-b border-white/[0.06]">
            <article className={`${mArticle} max-w-4xl`}>
              <LivingPulse />
              <p className={`${mEyebrow} smohix-eyebrow-cyber`}>⟡ Cybersecurity</p>
          ...
          <div className="smohix-quantum-section mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-16">
            <h2 className={`smohix-living-headline ${mH2}`}>Security capabilities</h2>
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              {capabilities.map((cap) => (
                <Link
                  ...
                  id={cap.id}
                  href={cap.href}
                  className={`smohix-bento-cell ${mCard} block scroll-mt-24 no-underline`}
                >
            ...
            <section
              className="smohix-quantum-core smohix-holo-panel mt-12 p-6 sm:p-8"
              aria-labelledby="soc-heading"
            >
              <h2 id="soc-heading" className={`smohix-living-headline ${mH2}`}>
