...
/** Cron: POST with Bearer ZENTRO_OBLIGATION_DENSITY_ALERT_CRON_SECRET. Body: `{ orgId, force? }` */
export async function POST(req: NextRequest) {
  const secret = process.env.ZENTRO_OBLIGATION_DENSITY_ALERT_CRON_SECRET?.trim();
  if (!secret) {
