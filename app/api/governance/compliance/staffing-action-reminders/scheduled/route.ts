...
/** Cron: POST with Bearer ZENTRO_STAFFING_OVERDUE_REMINDER_CRON_SECRET. Body: `{ orgId, force? }` */
export async function POST(req: NextRequest) {
  const secret = process.env.ZENTRO_STAFFING_OVERDUE_REMINDER_CRON_SECRET?.trim();
  if (!secret) {
