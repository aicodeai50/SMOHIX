...
/** Cron: POST with Bearer ZENTRO_OBLIGATION_COMMITTEE_DIGEST_CRON_SECRET. Body: `{ orgId, force? }` */
export async function POST(req: NextRequest) {
  const secret = process.env.ZENTRO_OBLIGATION_COMMITTEE_DIGEST_CRON_SECRET?.trim();
  if (!secret) {
