    ...
    <section className="relative overflow-hidden border-b border-white/[0.06]">
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24">
        <h1 className="shynvo-headline max-w-3xl text-3xl font-semibold tracking-tight sm:text-4xl sm:leading-tight md:text-[2.5rem]">
          Incident response with approval-gated automation
        </h1>
        <p className="mt-5 max-w-2xl text-base leading-relaxed text-muted sm:text-lg">
          Dry-runs, human checkpoints, and an append-only activity log in one console. Add
          organization sign-in when your team wants shared history, billing, and connectors.
        </p>
        <div className="mt-9">
          <Link
            href="/hub"
