...
export function LivingPulse() {
  ...
  return (
    <div
      className="smohix-living-pulse smohix-ascension-badge mb-6 inline-flex flex-wrap items-center gap-x-4 gap-y-2 rounded-full border border-white/[0.08] bg-black/30 px-4 py-2 font-mono text-[10px] uppercase tracking-[0.22em] backdrop-blur-md"
      aria-live="polite"
    >
      <span className="flex items-center gap-2 text-[#6ee7b7]">
        <span
          className={`smohix-pulse-dot inline-block h-2 w-2 rounded-full bg-[#6ee7b7] ${pulse ? "opacity-100" : "opacity-40"}`}
        />
        Live
      </span>
