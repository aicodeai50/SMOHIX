    ...
    <div className="flex gap-3 text-sm">
      <span
        className={`mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full text-xs font-bold ${
          ok
            ? "bg-emerald-500/20 text-emerald-200/95"
  ...
  return (
    <div className="rounded-2xl border border-white/[0.1] bg-white/[0.03] p-5 md:p-6">
      ...
      <p className="mt-2 text-sm leading-relaxed text-muted">
        Shynvo defaults to safe paths: prove intent with a dry-run, route destructive work through
        approvals, and keep evidence in audit.
      </p>
